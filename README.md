...
1. Navigate to ["API keys" Settings page](https://app.contentful.com/spaces/7fxw4qgdq4v5/api/cma_tokens) of your Contentful space and generate new "Personal Access Token"
...
To start editing your site, you can use the Contentful interface at [https://app.contentful.com/spaces/7fxw4qgdq4v5](https://app.contentful.com/spaces/7fxw4qgdq4v5).
...
Generated at `2021-10-27T09:01:19.969Z` by Stackbit version `0.3.55`.